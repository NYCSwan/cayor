    ...
    teamDetails: [
      {
        ...
        experience: [
          'Founding Partner of Cayor. Previously served as a non-executive director on a number of boards in Africa, and on one of the investment committees of the PIC, a South African pension fund manager in excess of US$100 billion in AUM. ',
          ...
          'As deal partner at Actis, he was a member of the management team and partnership group responsible for managing over US$2 billion, 30 investment professionals and 10 operations staff, across 5 offices across Africa. ',
      ...
      },
      {
        ...
        experience: [
          'Founding partner of Cayor Capital. ',
          'Prior to starting Cayor, he was head of Africa Private Investments at The Rohatyn Group (TRG), an emerging markets specialist asset manager with AUM, handling approximately US$5 billion, and in CVCI Private Equity, the emerging markets private equity division of Citi, which was acquired by TRG. ',
          'At CVCI/TRG, over a 10 year period, he was responsible for investing and divesting the CVCI/TRG Africa Fund, a US$100 million sector. ',
          'Previous experience as a partner at NEWE Partners, an investment and advisory firm focused on Africa. ',
          'He gained valuable experience as partner at AIG Private Equity in New York, and founding member of AIG Horizon Partners, an AIG sponsored US$400 million mid-market private equity fund focused on US and European markets.',
        ],
        education:
      ...
      },
      {
        ...
        experience: [
          ...
          'He began as a corporate finance professional at Cauris Finance Afrique, an advisory boutique in Johannesburg. ',
        ],
        education:
      ...
      },
      {
        ...
        experience: [
          'Prior to Joining Cayor, Principal at Arcadian Investment Partners, an Africa-focused investment advisory firm. He advised on transactions representing both sell-side and buy-side interests, spanning venture capital to infrastructure projects in Africa. ',
